            ...
            <div class="max-w-[400px]  mx-auto p-4 bg-white shadow-md rounded-lg">
              ...
              <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600 justify-end">
                ...
                <button data-modal-target="default-modal" data-modal-toggle="default-modal"
                    ...
                    data-salary="Rp{{ $post->salary }}" data-address="{{ $post->company->address }}"
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5 space-y-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-gray-900" id="modal-salary">Salary</p>
                            </div>
                            <div>
                                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">Alamat Perusahaan</p>
                                <p class="text-sm font-semibold text-gray-900" id="modal-address">Address</p>
                            </div>
                            <div>
                                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">Kategori Pekerjaan</p>
                                <p class="text-sm font-semibold text-gray-900" id="modal-category-id">Category ID</p>
                            </div>
                            <div>
                                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">Deskripsi Pekerjaan
                                </p>
                                <p class="text-sm font-semibold text-gray-900" id="modal-job-description">Job Description
                                </p>
                            </div>
                        </div>
                        <!-- Modal footer -->
