    ...
    @endif
    <div
        class="grid smaller:grid-cols-1 lg:grid-cols-3 md:grid-cols-2 larger:grid-cols-4 gap-10 mx-[20px] lg:mx-[70px]  mt-8">


        @foreach ($posts as $post)
            <div
                class="lg:w-[300px] md:w-[370px] lg:max-w-fit smaller:w-full h-[370px] mx-auto pt-4 pb-0 ps-4 pe-4 bg-white shadow-md rounded-lg border-2 border-LightGrey">
                ...
                <div class="mb-2 h-20 w-full my-10">
                    <div class="flex items-center">
                        <svg width="20" height="20" viewBox="0 0 30 30" fill="none"
                            ...
                            <path
                                d="M14.9998 6.59961V23.3996M19.1998 11.4996C19.1998 9.56761 17.3196 7.99961 14.9998 7.99961C12.68 7.99961 10.7998 9.56761 10.7998 11.4996C10.7998 13.4316 12.68 14.9996 14.9998 14.9996C17.3196 14.9996 19.1998 16.5676 19.1998 18.4996C19.1998 20.4316 17.3196 21.9996 14.9998 21.9996C12.68 21.9996 10.7998 20.4316 10.7998 18.4996"
                                stroke="#161616" stroke-width="2" stroke-linecap="round" />
                            <path
                                d="M8 2.87322C10.1273 1.64248 12.5423 0.99623 15 1.00002C22.7322 1.00002 29 7.26782 29 15C29 22.7322 22.7322 29 15 29C7.2678 29 1 22.7322 1 15C1 12.4506 1.6818 10.058 2.8732 8.00002"
                                stroke="#161616" stroke-width="2" stroke-linecap="round" />
                        </svg>
                        <p class="text-sm font-medium text-gray-900 ms-2 whitespace-nowrap">
                            Rp{{ number_format($post->min_salary, 2, ',', '.') }}
                ...
                <div class="flex justify-between mt-7">
                    ...
                    <a href="{{ route('hapusUserPost', ['id' => $user->bookmarks->where('post_id', $post->id)->id]) }}" class="w-full">
                    ...
                    @else
                    <a href="{{ route('disimpanUserPost', ['id' => $post->id]) }}" class="w-full">
                        <button class="" id="bookmarkbtn">
                            <svg class="my-2" width="18" height="24" viewBox="0 0 18 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M1.125 0.0546875H16.875C17.1734 0.0546875 17.4595 0.173214 17.6705 0.384192C17.8815 0.595171 18 0.881319 18 1.17969V22.7156C18.0001 22.8161 17.9733 22.9149 17.9223 23.0016C17.8712 23.0883 17.7979 23.1597 17.7099 23.2084C17.6219 23.2571 17.5225 23.2813 17.4219 23.2786C17.3214 23.2758 17.2234 23.2461 17.1382 23.1926L9 18.0884L0.86175 23.1914C0.776664 23.2449 0.678811 23.2746 0.578365 23.2774C0.477919 23.2803 0.378547 23.2561 0.290582 23.2076C0.202617 23.159 0.12927 23.0877 0.0781682 23.0012C0.0270661 22.9147 7.47797e-05 22.816 0 22.7156V1.17969C0 0.881319 0.118527 0.595171 0.329505 0.384192C0.540484 0.173214 0.826631 0.0546875 1.125 0.0546875ZM15.75 2.30469H2.25V19.6657L9 15.4346L15.75 19.6657V2.30469Z"
                                    fill="black" />
                            </svg>
                        </button>
                    </a>
                    ...
                    <div class="relative p-4 w-full max-w-lg max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 space-y-4">
                                ...
                                <div>
                                    <p class="text-sm leading-relaxed text-gray-500 dark:text-gray-400">Estimasi Gaji
                                    </p>
                                    <p class="text-base font-semibold text-gray-900"><span id="modal-min_salary"></span>
                                        - <span id="modal-max_salary"></span></p>
                                </div>
                                <div>
                                    <p class="text-sm leading-relaxed text-gray-500 dark:text-gray-400">Alamat
                                        Perusahaan
                                    </p>
                                    <p class="text-base font-semibold text-gray-900" id="modal-address">Address</p>
                                </div>
                                <div>
                                    <p class="text-sm leading-relaxed text-gray-500 dark:text-gray-400">Kategori
                                        Pekerjaan
                                    </p>
                                    <p class="text-base font-semibold text-gray-900" id="modal-category-id">Category ID
                                    </p>
                                </div>
                                <div>
                            ...
                            Simpan
                                ...
                                <button id="reportbtn">
                                    <svg width="32" height="32" viewBox="0 0 42 42" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="20.9531" cy="21" r="19.6406" stroke="#FC2828"
                                            stroke-width="2.625" />
                                        <path
                                            d="M21 8.67188C20.3922 8.67188 19.8364 9.18841 19.8771 9.79477L20.4386 24.9538C20.4386 25.1028 20.4977 25.2456 20.603 25.3509C20.7083 25.4561 20.8511 25.5153 21 25.5153C21.1489 25.5153 21.2917 25.4561 21.397 25.3509C21.5023 25.2456 21.5614 25.1028 21.5614 24.9538L22.1229 9.79477C22.1636 9.18841 21.6078 8.67188 21 8.67188Z"
                                            fill="#FC2828" stroke="#FC2828" stroke-width="1.875"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M21.0001 33.3757C21.6202 33.3757 22.123 32.8729 22.123 32.2528C22.123 31.6326 21.6202 31.1299 21.0001 31.1299C20.3799 31.1299 19.8772 31.6326 19.8772 32.2528C19.8772 32.8729 20.3799 33.3757 21.0001 33.3757Z"
                                            fill="#FC2828" stroke="#FC2828" stroke-width="1.875"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </button>
