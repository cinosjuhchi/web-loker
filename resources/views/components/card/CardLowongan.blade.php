        ...
        @foreach ($posts as $post)
            <div class="max-w-[400px] h-[300px] mx-auto p-4 bg-white shadow-md rounded-lg">
                ...
                <button data-modal-target="default-modal" data-modal-toggle="default-modal"
                    class="w-full bg-biru-tuwak text-white py-2 rounded-full open-modal mb-3"
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5 space-y-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-gray-900"><span id="modal-min_salary"></span> - <span
