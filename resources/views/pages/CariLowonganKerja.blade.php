...
@section('main')
    ...
    <div class="flex justify-center relative mt-20">
        <img class="w-full h-full object-cover" src="{{ Vite::asset('resources/assets/Rectangle86.png') }}"
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center text-center text-white">
            ...
            <div class="flex lg:mt-8 mt-4 space-x-4">
                <a href="/register"
                    class="bg-biru-tuwak hover:bg-blue-300 text-white font-medium rounded-3xl text-sm px-9 py-2.5">Daftar</a>
                <a href="/login"
                    class="border border-white hover:bg-black text-white font-medium rounded-3xl text-sm px-9 py-2">Masuk</a>
            </div>
        </div>
    </div>
@endsection
