...
@section('main')
    <div class="mx-[20px] lg:mx-[70px] mt-12">
        <h1 class="text-xl lg:text-3xl font-semibold">Cari Profil Perusahaan</h1>
        <p class="font-medium mt-2 text-gray-500">Cari profil perusahaan yang ingin kamu lihat</p>
    </div>
