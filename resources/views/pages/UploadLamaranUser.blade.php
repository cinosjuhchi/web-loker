...
@section('uploadLamaran')
    <div class="m-4 md:m-12">
        <div>
            ...
            <h1 class="font-bold text-2xl md:text-3xl mb-8">Lamar Pekerjaan {{ $post->title }} di
                    ...
                    <form action="{{ route('postlamaran')}}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="lg:flex  w-full gap-5">
                            <div class=" lg:w-[50%]">
                                ...
                                <div>
                                    <input id="nama" type="text" name="nama" value="{{ auth()->user()->name }}"
                                ...
                                <div>
                                    <input id="telepon" type="text" name="nomor_telepon"
                                        value="{{ auth()->user()->number_phone }}" placeholder="Masukkan nomor telpon anda"
                                        class="py-4 px-5 w-full rounded-md mt-3 mb-5 text-black border-2 ring-2 ring-gray-200 focus:border-blue-500 outline-none focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                            ...
                            <div class=" lg:w-[50%]">
                                ...
                                <div class="mt-5">
                                    ...
                                    <input type="file" id="file-input" accept=".pdf"
                                        value="{{ auth()->user()->default_cv }}" name="cv" placeholder="Pilih File"
                                ...
                                <div class="flex gap-3 lg:mt-5 mt-4 mb-10 w-full justify-end">
                                    ...
                                    <button id="submitLamaranButton" type="submit"
                                        class="px-5  bg-biru-tuwak font-semibold rounded-full text-white ">Kirim</button>
                                </div>
                            </div>
                        </div>
                    </form>
