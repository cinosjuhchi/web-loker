...
<div class="w-full flex">
 ...
 <h1 class="font-extrabold text-3xl px-6 text-justify">Ingin menemukan pekerjaan yang sesuai dengan minat dan keterampilan Anda? Jelajahi lowongan pekerjaan di website kami!
</h1>
<h1 class="mt-6 px-6 text-justify">Di sini, Anda akan menemukan lingkungan kerja yang inklusif dan kolaboratif, di mana setiap suara dihargai dan setiap ide didorong untuk  tumbuh. Kami percaya bahwa keragaman adalah kunci untuk inovasi, dan  kami berkomitmen untuk merangkul perbedaan agar dapat menciptakan  solusi yang lebih baik.</h1>
</div>
