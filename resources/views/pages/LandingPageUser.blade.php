...
<div class=" mt-20">
  ...
  <div class=" min-[300px]:w-full">
    ...
    <div class="rounded-full text-white bg-biru-tuwak lg:h-[28px] lg:w-[28px]   text-center pt-0.5 text-bold text-base my-auto ml-5">1</div>
    ...
    <div class="lg:w-[700px] min-[300px]:w-fullh-22 bg-LightBlue  rounded-md mb-4 flex" >
