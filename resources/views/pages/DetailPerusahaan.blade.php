...
@section('detailPerusahaanUserPage')
    <div class="">
        <div class="relative">
            <img src="{{ $company->photo_banner ? asset($company->photo_banner) : Vite::asset('resources/assets/placeholder.png') }}"
            ...
            <div class="absolute inset-x-0 bottom-0 transform translate-y-1/2 flex justify-center ">
                <img src="{{ $company->photo_profile ? asset($company->photo_profile) : Vite::asset('resources/assets/placeholder.png') }}"
                    alt="Profile
                    Picture" class="w-32 h-32 rounded-full border-4 border-white">
            </div>
        </div>
        ...
        <div class="mt-16 text-center">
            ...
            <h1 class="text-md font-light max-w-xl mx-auto truncate">{{ $company->description }}</h1>
        </div>
            ...
            <div class=" justify-center lg:flex block w-fit mx-auto gap-2">
                <div class="mb-4 lg:mb-0 ">
                    <a href="#lowongan-tersedia"> <button
                            class="py-3 lg:px-4 bg-biru-tuwak rounded-full focus:ring-0 px-4 border-none text-white">Lihat
                            Lowongan Keja</button></a>
    ...
    <div class="lg:mx-[100px] mx-5 mb-5">
        ...
        <div>
            ...
            <div class="mb-4">
                ...
                <h3 class="text-xl font-semibold">{{ $company->company_name }}</h3>
            </div>
            <div class="mb-4">
                <p class="text-gray-700 text-md">Bidang Perusahaan</p>
                <h3 class="text-xl font-semibold">{{ $company->category->name }}</h3>
            </div>
            <div class="mb-4">
                <p class="text-gray-700 text-md">Alamat Perusahaan</p>
                <h3 class="text-xl font-semibold">{{ $company->address }}</h3>
            </div>
            <div class="mb-10">
                <p class="text-gray-700 text-md">Deskripsi Perusahaan</p>
                <h3 class="text-xl font-semibold">{{ $company->description }}</h3>
            </div>
            ...
            <div class="mb-10">
                <div class="flex gap-4">
                    <svg class="w-8 h-8 text-biru-tuwak dark:text-white" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-width="2"
                            d="m3.5 5.5 7.893 6.036a1 1 0 0 0 1.214 0L20.5 5.5M4 19h16a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1Z" />
                    </svg>
                    <h3 class="text-md underline underline-offset-4 text-biru-tuwak font-semibold">{{ $company->company_email }}
                    </h3>
                </div>
                <div class="flex gap-4 mt-4">
                    ...
                    <h3 class="text-md underline underline-offset-4 text-biru-tuwak font-semibold">{{ $company->number_phone }}</h3>
                </div>
            </div>

            <div id="lowongan-tersedia">
                <h1 class="font-bold text-2xl mb-5">Lowongan Kerja Yang Tersedia di perusahaan ini</h1>
